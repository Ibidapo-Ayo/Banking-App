...
import { FeaturesData } from "../components/DummyData/FeaturesData";
      ...
      <div className="container flex flex-col px-30 md:px-40 mx-auto mt-10 space-y-12 md:space-y-0 md:flex-row">
        ...
        <div className="md:w-1/2 w-90 shadow-2xl pt-3 p-10 md:p-9 space-y-2 md:pt-5">
          <div className="max-w-xl">
            ...
            <select id="" value={select} onChange={setSelector} className="feature-form form-select text-2xl rounded-2xl bg-gray-200 font-bold border-gray-300 outline-none">
            ...
            <p className='text-2xl text-center font-bold'>{Number(loan) === 0 ? '' : `# ${loan * 3}`}</p>
